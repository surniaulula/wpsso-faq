 ...
 * Description: WPSSO Core add-on to remove outdated / incomplete Schema Microdata to use Google's preferred Schema JSON-LD for SEO Rich Results.
...
if ( ! class_exists( 'WpssoFaq' ) ) {
	...
	class WpssoFaq {
		...
		public static function required_notice( $deactivate = false ) {
			...
			$die_msg = __( '%1$s is an add-on for the %2$s plugin &mdash; please install and activate the %3$s plugin before activating %4$s.', 'wpsso-faq' );
