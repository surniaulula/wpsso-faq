...
<tr><th align="right" valign="top" nowrap>Tags / Keywords</th><td>faq</td></tr>
</table>
...
<p>FAQ category archive pages are assigned the Schema FAQPage type automatically in the Document SSO metabox.</p>

<p>Question (and Answer) pages are assigned the Schema Question type automatically in the Document SSO metabox.</p>
...
<p>This plugin manages FAQ categories and Question (and Answer) pages -- it does not create any meta tags or Schema markup in those pages. If you need Schema FAQPage and Schema Question markup (in JSON-LD format) for your pages, you will also need the <a href="https://wpsso.com/extend/plugins/wpsso-schema-json-ld/">WPSSO Schema JSON-LD Markup (Premium) add-on</a> to create the Schema JSON-LD markup.</p>
